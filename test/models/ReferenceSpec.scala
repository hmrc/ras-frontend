...
class ReferenceSpec extends AnyWordSpec with Matchers {

  "Reference" should {

    "create a Reference with a value" in {
      val reference = Reference("test-reference")
      reference.value shouldBe "test-reference"
    }
