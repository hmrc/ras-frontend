...
class FileReadyViewSpec extends AnyWordSpec with RasTestHelper {
  ...
  "file ready page" must {
    ...
    "contain the correct ga events" in {
      ...
      doc(result)
        .getElementById("download-your-file-link")
        .attr("data-journey-click")                                 shouldBe "link - click:File ready:Download your file"
    }
  }
