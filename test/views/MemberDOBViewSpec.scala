    ...
    "contain correct page elements and content" when {
      ...
      "contain the correct ga data when edit mode is false" in {
        ...
        doc(result)
          ...
          .attr("data-journey-click") shouldBe "button - click:What is their DOB?:Continue"
        doc(result)
          .getElementsByClass("govuk-back-link")
          .attr("data-journey-click") shouldBe "navigation - link:What is their DOB?:Back"
      }
      ...
      "contain the correct ga data when edit mode is true" in {
        ...
        doc(result)
          .getElementById("continue")
          .attr("data-journey-click") shouldBe "button - click:What is their DOB?:Continue and submit"
      }
    }
