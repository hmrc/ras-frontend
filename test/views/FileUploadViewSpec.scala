  ...
  "file upload page" when {
    ...
    "contains the correct ga events" in {
      ...
      doc(result)
        ...
        .attr("data-journey-click")                                     shouldBe "navigation - link:Upload a file:Back"
      doc(result)
        .getElementById("choose-file")
        .attr("data-journey-click")                                     shouldBe "button - click:Upload a file:Choose file"
      doc(result)
        .getElementById("upload-help-link")
        .attr("data-journey-click")                                     shouldBe "link - click:Upload a file:Get help formatting your file"
    }
    ...
    "the get help link should be correct" in {
      ...
      doc(result)
        ...
        .attr(
          "href"
        ) shouldBe "http://www.gov.uk/guidance/find-the-relief-at-source-residency-statuses-of-multiple-members"
    }
